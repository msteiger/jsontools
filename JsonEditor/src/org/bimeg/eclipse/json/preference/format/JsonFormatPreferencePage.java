package org.bimeg.eclipse.json.preference.format;

import org.bimeg.eclipse.json.JsonPlugin;
import org.bimeg.eclipse.json.preference.JsonPreferencesInitializer;
import org.bimeg.eclipse.json.preference.PseudoPreferenceStore;
...
public class JsonFormatPreferencePage extends PreferencePage implements IWorkbenchPreferencePage, SelectionListener
{
	...
	private final IPreferenceStore mPreferenceStore;

	public JsonFormatPreferencePage()
	{
		mPreferenceStore = new PseudoPreferenceStore();
		final IPreferenceStore store = JsonPlugin.getDefault().getPreferenceStore();

		clonePref(store, mPreferenceStore);
	}
	...
	{
		clonePref(mPreferenceStore, JsonPlugin.getDefault().getPreferenceStore());
